...
const part1 = charLists => {
    ...
    charLists.forEach(curCharList => {
        curCharList.counts.forEach((count, j) => {
            curMessageObj = messageArr[j];
            
            if(count > curMessageObj.n){
                curMessageObj.c = curCharList.char;
                curMessageObj.n = count;
            }
        })
    });
