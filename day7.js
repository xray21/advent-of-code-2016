...
const part1 = () => {
	...
	input.forEach(str => {
		...
		for(i = 0; i<chars.length; i++){
			...
			if(stack.length >= 4){
				var c1 = stack[stack.length - 4];
				var c2 = stack[stack.length - 3];
				var c3 = stack[stack.length - 2];
				var c4 = c;
...
const part2 = () => {
	...
	input.forEach(str => {
		...
		for(i = 0; i<chars.length; i++){
			...
			if(stack.length >= 3){
				var c1 = stack[stack.length - 3];
				var c2 = stack[stack.length - 2];
				var c3 = c;
				
				if(c1 == c3 && c1 !== c2){
					var curStr = c1 + c2 + c3;
					var compStr = c2 + c1 + c2;
					
					if(brackCount <= 0){
						outsideStrs.push(curStr);
						
						if(bracketStrs.length > 0 && bracketStrs.indexOf(compStr) !== -1){
							console.log(curStr, compStr);
							console.log(outsideStrs, bracketStrs);
					...
					if(brackCount > 0){
						bracketStrs.push(curStr);
						
						if(outsideStrs.length > 0 && outsideStrs.indexOf(compStr) !== -1){
							console.log(curStr, compStr);
							console.log(outsideStrs, bracketStrs);
